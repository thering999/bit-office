...
## Structured Knowledge Reporting (CRITICAL)
To maintain the **Project Knowledge Base**, agents MUST include the following tags in their final task completion messages:
- `MODULES: [list of added/modified modules]`
- `FEATURES: [list of added/modified features]`
- `LEARNINGS: [any non-obvious technical insights discovered]`
This data is automatically extracted and indexed for context-aware autonomous coding.
