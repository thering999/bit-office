...
export interface ErrorSolution {
  title: string;
  description: string;
  action?: string; // Optional command or action name
}
...
export class AgentErrorHandler {
   ...
   */
  static translate(error: string, context?: { command?: string; agentId?: string }): ErrorTranslation {
   ...
   */
  static formatThai(error: string, context?: { command?: string; agentId?: string }): string {
