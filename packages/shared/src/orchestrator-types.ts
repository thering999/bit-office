import { AgentStatus, RiskLevel, Decision, TeamPhase } from "./types";
...
export interface OrchAgentActivityEvent {
  ...
  agentName: string;
  intent: string;
  phase: "started" | "completed" | "health";
  touchedFiles?: string[];
  exports?: string[];
  needs?: string[];
}
...
export type OrchestratorEvent =
  ...
  | OrchTaskDoneEvent
  | OrchTaskFailedEvent
  | OrchTaskDelegatedEvent
  | OrchTaskRetryingEvent
  | OrchAgentStatusEvent
  | OrchApprovalNeededEvent
  | OrchLogAppendEvent
  | OrchTeamChatEvent
  | OrchTaskQueuedEvent
  | OrchWorktreeCreatedEvent
  | OrchWorktreeMergedEvent
  | OrchAgentActivityEvent
  | OrchAgentCreatedEvent
  | OrchAgentFiredEvent
  | OrchTaskResultReturnedEvent
  | OrchTeamPhaseChangedEvent
  | OrchTokenUpdateEvent
  | OrchMetaThoughtEvent
  | OrchToolStartedEvent
  | OrchToolFinishedEvent
  | OrchReflectionEvent
  | OrchSwarmHealthEvent
  | OrchSwarmReassemblyEvent;
